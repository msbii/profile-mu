...
<div class="col-lg-8">
    ...
    {{-- Untuk dapat menangani file harus ditambah enctype --}}
      <form method="POST" action="/dashboard/musyawarah" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="datetime-local" class="form-control @error('time')is-invalid @enderror" id="time" name="time" required autofocus value="{{ old('time') }}">
          @error('time')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="mb-3">
          ...
          @error('hasil')
              <p class="text-danger">{{ $message }}</p>
          @enderror
            <input id="hasil" type="hidden" name="hasil" value="{{ old('hasil') }}">
