...
@section('container')
        ...
        <div class="col-md-6 justify-content-center mb-5">
                    ...
                    <h2>{{ $post->title }}</h2>
                    <h5>{{ \Carbon\Carbon::parse($post->time)->translatedFormat('d F Y, H:i') }}</h5>
                    <h5>{{ $post->Lingkup->name }}</h5>
                    
                    <a href="/dashboard/musyawarah" class="btn btn-success"><i class="bi bi-arrow-left"></i>Kembali ke semua Postingan Saya</a>
                    <a href="/dashboard/musyawarah/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Ubah</a>

                    {{-- Mengaktifkan fitur delete --}}
                    <form action="/dashboard/musyawarah/{{ $post->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
    ...
    {{-- <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-6">
                    ...
                    <a href="/dashboard/musyawarah" class="btn btn-success"><i class="bi bi-arrow-left"></i>Back to all My Posts</a>
