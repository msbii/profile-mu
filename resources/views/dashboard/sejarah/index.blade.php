                            ...
                            @endif     
                                <a href="/dashboard/sejarah/create">
                                    <button type="button" class="btn btn-success my-2">
                                        <i class="fas fa-plus"></i> Buat Sejarah baru
                                    </button>
                                </a>
                                
                                <div class="row g-3 mb-3">
                                    <!-- SEARCH FORM -->
                                    {{-- <form class="col-auto" action="/dashboard/sejarah" method="GET"> --}}
                                    <form class="col-auto" action="/sejarah/search" method="GET">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    {{-- @if (Auth::check())
                                        ...
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items">{{ $post->title }} </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addProductModalLabel">Tambah Sejarah Baru</h5>
