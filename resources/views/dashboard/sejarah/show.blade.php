...
@section('container')
        ...
        <div class="col-md-6 justify-content-center mb-5">
                    ...
                    <a href="/dashboard/sejarah" class="btn btn-success"><i class="bi bi-arrow-left"></i>Kembali ke semua Postingan Saya</a>
                    <a href="/dashboard/sejarah/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Ubah</a>
