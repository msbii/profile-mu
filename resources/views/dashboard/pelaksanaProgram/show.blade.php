...
@section('container')
        ...
        <div class="col-md-6 justify-content-center mb-5">
                    ...
                    <a href="/dashboard/pelaksanaanProgram" class="btn btn-success"><i class="bi bi-arrow-left"></i>Kembali ke semua Postingan Saya</a>
                    <a href="/dashboard/pelaksanaanProgram/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Ubah</a>

                    {{-- Mengaktifkan fitur delete --}}
                    <form action="/dashboard/pelaksanaanProgram/{{ $post->slug }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
    ...
    {{-- <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-6">
                    ...
                    <a href="/dashboard/pelaksanaanProgram" class="btn btn-success"><i class="bi bi-arrow-left"></i>Back to all My Posts</a>
