                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Pelaksanaan Program</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                            ...
                            @endif     
                                <a href="/dashboard/pelaksanaanProgram/create">
                                ...
                                <div class="row g-3 mb-3">
                                    <!-- SEARCH FORM -->
                                    <form class="col-auto" action="/pelaksanaProgram/search" method="GET">
                                    ...
                                    {{-- @if (Auth::check())
                                        ...
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items">
                                                ...
                                                <a href="/dashboard/pelaksanaanProgram/{{ $post->slug }}">
                                                    <button class="btn btn-success mx-1 btn-view ">
                                                        <i class="bi bi-file-earmark-text bg-info"></i> Lihat
                                                    </button>
                                                </a>
                                                <a href="/dashboard/pelaksanaanProgram/{{ $post->slug }}/edit">
