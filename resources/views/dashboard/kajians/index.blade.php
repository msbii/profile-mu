                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Kajian Saya</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                            ...
                            @endif     
                                <a href="/dashboard/kajian/create">
                                ...
                                <div class="row g-3 mb-3">
                                    <!-- SEARCH FORM -->
                                    <form class="col-auto" action="/kajians/search" method="GET">
                                        {{-- query filter --}}
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    {{-- @if (Auth::check())
                                        ...
                                        <tr class="account__table--body__child">
                                            ...
                                            <td class="account__table--body__child--items">{{ $post->speaker }}</td>
                                            <td class="account__table--body__child--items">{{ $post->kategoriKajian->name }}</td>
