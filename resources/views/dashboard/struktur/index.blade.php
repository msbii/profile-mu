                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Halaman Struktur Organisasi</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                            ...
                            @endif     
                                <a href="/dashboard/struktur/create">
                                    <button type="button" class="btn btn-success my-2">
                                        <i class="fas fa-plus"></i> Tambah Gambar Struktur Baru
                                    </button>
                                </a>
                                
                                <div class="row g-3 mb-3">
                                    <!-- SEARCH FORM -->
                                    <form class="col-auto" action="/struktur/search" method="GET">
                                        {{-- query filter --}}
