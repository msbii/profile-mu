...
<div class="col-lg-8">
    ...
    <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ubah Biodata</h1>
    </div>
    {{-- method mempengaruhi route post akan mengarah ke store --}}
      <form method="POST" action="/dashboard/biodataPimpinan/{{ $post->slug }}" class="mb-5"
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="position">
            ...
            @if (old('position',$post->position) == $category->id)
        ...
        <div class="mb-3">
          ...
          @enderror
            <input id="biography" type="hidden" name="biography" value="{{ old('biography', $post->biography) }}">
