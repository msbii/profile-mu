...
@section('container')
        ...
        <div class="col-md-6 justify-content-center mb-5">
                    ...
                    <a href="/dashboard/biodataPimpinan" class="btn btn-success"><i class="bi bi-arrow-left"></i>Kembali ke semua Postingan Saya</a>
                    <a href="/dashboard/biodataPimpinan/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Ubah</a>
                    ...
                    <div style="max-height: 400px; overflow:hidden;">
                        ...
                        <img src="{{ asset('storage/' . $post->image) }}" class="card-img-top mt-3" alt="{{ $post->Position->name }}">
                    </div>
                    @else

                    <img src="https://source.unsplash.com/1200x400?{{ $post->Position->name }}" class="card-img-top mt-3" alt="{{ $post->Position->name }}">
                    @endif
    ...
    {{-- <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-6">
                    ...
                    <a href="/dashboard/biodataPimpinan" class="btn btn-success"><i class="bi bi-arrow-left"></i>Back to all My Posts</a>
