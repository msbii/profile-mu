...
<div class="col-lg-8">
    ...
    <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Data Inventaris Baru</h1>
    </div>
    {{-- method mempengaruhi route post akan mengarah ke store --}}
    {{-- Untuk dapat menangani file harus ditambah enctype --}}
      <form method="POST" action="/dashboard/inventaris" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="location_id">
            ...
            @if (old('location_id') == $category->id)
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control @error('quantity')is-invalid @enderror" id="quantity" name="quantity" required autofocus value="{{ old('quantity') }}">
          @error('quantity')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
        ...
        <div class="mb-3">
          <label for="location" class="form-label">Detail location</label>
        ...
        <button type="submit" class="btn btn-primary">Buat Inventaris</button>
      </form>
</div>
