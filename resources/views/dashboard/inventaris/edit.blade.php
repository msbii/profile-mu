...
<div class="col-lg-8">
    ...
    <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ubah Inventaris</h1>
    </div>
    {{-- method mempengaruhi route post akan mengarah ke store --}}
      <form method="POST" action="/dashboard/inventaris/{{ $post->slug }}" class="mb-5"
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="location_id">
            ...
            @if (old('location_id',$post->location_id) == $category->id)
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control @error('quantity')is-invalid @enderror" id="quantity" name="quantity" required autofocus value="{{ old('quantity', $post->quantity) }}">
          @error('quantity')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
