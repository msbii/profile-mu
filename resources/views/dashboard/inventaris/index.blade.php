                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            @endif     
                                <a href="/dashboard/inventaris/create">
                                ...
                                <div class="row g-3 mb-3">
                                    <!-- SEARCH FORM -->
                                    <form class="col-auto" action="/inventaris/search" method="GET">
