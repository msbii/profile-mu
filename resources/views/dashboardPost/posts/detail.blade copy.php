                ...
                <div class="col-md-12 text-center">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/' . $post->image) }}" width="700" height="400" class="img-fluid" alt="{{ $post->category->name }}">
                            </div>
                            @else
                            <div class="d-flex justify-content-center">
                                <img src="https://storage.googleapis.com/a1aa/image/fYtaLxmXcWwZE6OgwpSCiZjC55SLkvIj3QQshe5WZGwAookTA.jpg" width="700" height="400" class="img-fluid" alt="{{ $post->category->name }}">
                            </div>
