                        ...
                        <article class="column featured-news-column col-md-4 col-sm-6 col-xs-12">
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    @if ($post->image)
                                        <img src="{{ asset('storage/' . $post->image) }}" width="370" height="250" class="card-img-top" alt="{{ $post->category->name }}">
                                    @else
                                        <img src="{{ asset('img') }}/Template1.jpg" width="370" height="250" class="card-img-top" alt="{{ $posts[0]->category->name }}">
                                    @endif
                            ...
                            <div class="inner-box">
                                <figure class="image-box">
                                    ...
                                    @if ($post->image)
                                        ...
                                        <img src="{{ asset('storage/' . $post->image) }}" width="370" height="250" class="card-img-top" alt="{{ $post->kategoriKajian->name }}">
                                    @else
                                        {{-- <img src="https://source.unsplash.com/1200x400?{{ $post->kategoriKajian->name }}" class="card-img-top" alt="{{ $post->kategoriKajian->name }}"> --}}
                                        <img src="{{ asset('img') }}/Template1.jpg" width="370" height="250" class="card-img-top" alt="{{ $posts[0]->kategoriKajian->name }}">
                                    @endif
