...
@section('container')
        ...
        <section class="page-title" style="background-image:url('{{ asset('img/Logo3.jpg') }}');">
            <div class="auto-container">
            	<h1>Bakti Sosial Idul Adha Angkatan Muda</h1>
            </div>
        </section>
        ...
        <section class="page-info">
            <div class="auto-container clearfix">
            	<div class="pull-left"><h2>Bakti Sosial Idul Adha Angkatan Muda</h2></div>
                <div class="pull-right">
                	<ul class="bread-crumb clearfix">
                    	<li><a href="/">Beranda</a></li>
                        <li>Bakti Sosial Idul Adha Angkatan Muda</li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right">
                        ...
                        <section class="law-section">
                            <div class="">
                                ...
                                <h3>Bakti Sosial Idul Adha</h3><br>
                                <h3> {{ $baksos->title }}</h3>
                                ...
                                <div style="max-height: 400px; overflow:hidden;">
                                    ...
                                    <img src="{{ asset('storage/' . $baksos->image) }}" width="370" height="250" class="card-img-top" alt="{{ $baksos->title }}">
                                </div>
                                @else
