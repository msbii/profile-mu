                    ...
                    {{-- <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 pull-left">
                    	<aside class="sidebar">
                            ...
                            <div class="widget sidebar-widget boxed-nav">
                            	<nav class="nav-outer">
                                	<ul>
                                    	<li class="current"><a href="/view/muhammadiyah">All Practice Areas</a></li>
                                        <li><a href="/sejarah-muhammadiyah">Sejarah</a></li>
                                        <li><a href="law-single.html">Musyawarah Ranting</a></li>
                                        <li class="dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Organisasi</a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="">Struktur Organisasi</a></li>
                                                <li><a class="dropdown-item" href="">Biodata Pimpinan</a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="">Pimpinan Harian</a></li>
                                                <li><a class="dropdown-item" href="">Bagian Tablig</a></li>
                                                <li><a class="dropdown-item" href="">Bagian ...</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#law-single.html">Inventaris</a></li>
                                    </ul>
                                </nav>
                            </div>
