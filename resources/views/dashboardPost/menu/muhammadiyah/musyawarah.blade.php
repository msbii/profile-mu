                                        ...
                                        <article class="column featured-news-column col-md-6 col-lg-6 "> <!-- Menambahkan kelas grid untuk dua kolom -->
                                            <div class="inner-box clearfix">
                                                <figure class="image-box">
                                                    ...
                                                    @endif
                                                    <a href="/musyawarah/muhammadiyah/{{ $post->slug }}" class="default-overlay-outer">
                                                        <div class="inner">
                                                ...
                                                <div class="right-content">
                                                    <div class="content">
                                                        ...
                                                        <h3><a href="/musyawarah/muhammadiyah/{{ $post->slug }}">{{ $post->title }}</a></h3>
                                                        <div class="text">
                                                            <a href="/musyawarah/muhammadiyah/{{ $post->slug }}">
