...
@section('container')
        ...
        <section class="page-info">
            <div class="auto-container clearfix">
            	<div class="pull-left"><h2>Inventaris Aisyiyah</h2></div>
        ...
        <div class="sidebar-page-container">
            <div class="auto-container">
                <div class="row clearfix">
                                        ...
                                        <article class="column featured-news-column col-md-6 col-lg-6 "> <!-- Menambahkan kelas grid untuk dua kolom -->
                                            <div class="inner-box clearfix">
                                                <figure class="image-box">
                                                    ...
                                                    @endif
                                                    <a href="/inventaris/aisyiyah/{{ $post->slug }}" class="default-overlay-outer">
                                                        <div class="inner">
                                                ...
                                                <div class="right-content">
                                                    <div class="content">
                                                        ...
                                                        <h3><a href="/inventaris/aisyiyah/{{ $post->slug }}">{{ $post->title }}</a></h3>
                                                        <div class="text">
                                                            <a href="/inventaris/aisyiyah/{{ $post->slug }}">
                    ...
                    @include('dashboardPost/menu/aisyiyah/sidebar')
