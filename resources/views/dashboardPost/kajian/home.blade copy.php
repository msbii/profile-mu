...
<div class="container"> <!-- Container untuk memberikan jarak pada semua konten -->
    <h2 class="text-center text-primary fw-bold mb-4">Kajian</h2>
    @if ($kajian->count())
    <div class="row g-4"> <!-- Gutter antara kolom -->
        @foreach($kajian as $post)
            <!-- Artikel -->
            ...
            <article class="column featured-news-column col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="inner-box">
                    ...
                    {{-- <div class="card-img-top position-relative">
                        @if ($post->image)
                            <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid" alt="{{ $post->kategoriKajian->name }}">
                        @else
                            <img src="https://storage.googleapis.com/a1aa/image/fYtaLxmXcWwZE6OgwpSCiZjC55SLkvIj3QQshe5WZGwAookTA.jpg" class="img-fluid" alt="{{ $post->title }}">
                        @endif
                        <a href="/kajian/{{ $post->slug }}" class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center overlay">
                    ...
                    <figure class="image-box">
                        ...
                        @if ($post->image)
                            ...
                            <img src="{{ asset('storage/' . $post->image) }}" class="card-img-top" alt="{{ $post->kategoriKajian->name }}">
                        @else
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="/kategori/{{ $post->kategoriKajian->slug }}">
                                <span class="badge bg-secondary">{{ $post->kategoriKajian->name }}</span>
                            </a>
                            <small class="text-muted">{{ $post->created_at->format('d M Y') }}</small>
                        </div>
                        <h5 class="card-title mt-2"><a href="/kajian/{{ $post->slug }}" class="text-dark">{{ $post->title }}</a></h5>
                        ...
                        <a href="/kajian/{{ $post->slug }}" class="btn btn-primary btn-sm mt-2">Read More</a>
                    </div> --}}
                    <!-- Konten Artikel -->
                    <div class="content">
            ...
            <article class="column featured-news-column col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="inner-box">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{ Str::limit($post->excerpt, 100) }}</p>
                        <a href="/kajian/{{ $post->slug }}" class="btn btn-primary btn-sm mt-2">Baca Selengkapnya</a>
                    </div> --}}
                    <!-- Konten Artikel -->
                    <div class="content">
                        {{-- <div class="date">21<br>Aug</div> --}}
