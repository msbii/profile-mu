...
@section('container')
        ...
        <section class="page-title" style="background-image:url('{{ asset('img/Logo3.jpg') }}');">
            <div class="auto-container">
            	<h1>Amal Usaha Masjid Al Ikhsan</h1>
            </div>
        </section>
        ...
        <section class="page-info">
            <div class="auto-container clearfix">
            	<div class="pull-left"><h2>Amal Usaha Masjid Al Ikhsan</h2></div>
                <div class="pull-right">
                	<ul class="bread-crumb clearfix">
                    	<li><a href="/">Beranda</a></li>
                        <li>Amal Usaha Masjid Al Ikhsan</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <div class="sidebar-page-container">
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    @include('dashboardPost/amal/masjidAlIkhsan/sidebar')
