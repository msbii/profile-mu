...
@section('container')
        ...
        <section class="page-title" style="background-image:url('{{ asset('img/Logo3.jpg') }}');">
            <div class="auto-container">
            	<h1>Struktur Organisasi Mushola AL Khasanah</h1>
            </div>
        </section>
        ...
        <section class="page-info">
            <div class="auto-container clearfix">
            	<div class="pull-left"><h2>Struktur Organisasi Mushola AL Khasanah</h2></div>
                <div class="pull-right">
                	<ul class="bread-crumb clearfix">
                    	<li><a href="/">Beranda</a></li>
                        <li>Struktur Organisasi Mushola AL Khasanah</li>
                    </ul>
                </div>
            </div>
        </section>
