        ...
        <div class="sidebar-page-container">
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right">
                        ...
                        <section class="law-section">
                            <div class="text-center">
                                ...
                                <p>By. <a href="/authors/{{ $post->author->username }}" width="900" height="500"  class="text-decoration-none">{{ $post->author->name }}</a> 
                                ...
                                <a href="/amal/masjidAlAmien" class"d-block mt-3">Kembali ke Postingan</a>
                    ...
                    @include('dashboardPost/amal/masjidBaiturohman/sidebar')     
